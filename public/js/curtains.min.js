...
function Curtains(t) {
  ...
  t.container
    ...
    : this.productionMode ||
      console.warn(
        "No container HTML element or ID provided. Use setContainer() method to set a container and initialize the WebGL context"
      );
}
    ...
    if ("string" == typeof t) {
      if (((this.container = document.getElementById(t)), !this.container))
        return void (
          this.productionMode ||
          console.warn(
            "No container HTML element or ID provided. WebGL context couldn't be created"
          )
        );
    ...
    var i = this,
      s = setInterval(function () {
        0 === i.planes.length &&
          ...
          i._watchScroll &&
            window.removeEventListener("scroll", i._scrollManager.handler, {
              passive: !0,
            }),
